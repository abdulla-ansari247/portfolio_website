...
const translations = {
    hu: {
        ...
        'exp2-title':  'Akkumulátorcella Minőségellenőr és Osztályozó',
        'exp2-date':   '2026. jún. — jelenleg',
        'exp2-org':    'CATL (Contemporary Amperex Technology), Debrecen, Magyarország',
        'exp2-desc':   'A világ egyik legnagyobb lítium-ion akkumulátorgyártójának gyártósorán dolgozom. Szűk tűréshatárok között, precizitásra épülő gyártási környezetben végzem a munkát, ahol a következetesség és a részletekre való odafigyelés közvetlenül meghatározza a végtermék megbízhatóságát.',
        'exp3-title':  'Szabadúszó Programozó Fejlesztő',
        'exp3-date':   '2021. jan. — jelenleg',
        'exp3-org':    'Önálló / Távmunka',
        'exp3-desc':   'Egyedi szoftvermegoldásokat készítettem ügyféli projektekhez Python, JavaScript (Node.js), Java és HTML használatával. Kezeltem a backend logikát, interaktív webes komponenseket és a végponttól végpontig tartó szállítást, miközben önállóan kezeltem az ügyfélkommunikációt.',
        'exp4-title':  'Magántanár',
        'exp4-date':   '2020. szept. — 2026. júl.',
        'exp4-org':    'Önálló / Távmunka',
        'exp4-desc':   'Egyéni oktatás matematikából, fizikából és számítástechnikából általános és középiskolai szinten. Fókusz a strukturált problémamegoldáson, fogalmi megértésen és vizsgafelkészítésen.',
        'exp5-title':  'Kapcsolati Manager',
        'exp5-date':   '2023. febr. — 2023. júl.',
        'exp5-org':    'Bellavista Ingatlan, Dubai, UAE',
        'exp5-desc':   'Az ügyfelek, ügynökök, fejlesztők és nemzetközi ügynökségek közötti kapcsolattartó pontként működtem, koordinálva több fél között az ügyletek előrehaladásának biztosítása érdekében. Erős munkakapcsolatokat építettem ki egy gyors tempójú, emberközpontú környezetben.',
